...
\begin{itemize}
    ...
    \item A mechanism to compress the $renamingMap$ will be \mnnote{NOTE: is?} presented in section \ref{sec:optimisation-renamingMap}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item $priority$ is the same value as the $priority$ of the first tuple of the first element of the sequence. We explain this choice later in section \ref{sec:renameForwardPos}.
...
\subsubsection{\emph{Epochs} mechanism}
