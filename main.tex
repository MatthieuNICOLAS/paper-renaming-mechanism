...
\mnnote{Dans cette section, je veux expliquer le comportement du mécanisme de renommage via un exemple d'exécution où un noeud renomme la séquence répliquée tandis qu'un autre la modifie en concurrence (\autoref{fig:example-renaming}). De cette manière, les sections suivantes correspondront juste à expliquer comment on a conçu et implémenté la solution proposée}
