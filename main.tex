...
\mnnote{Besoin d'une section (ou autre) entre les limites de LogootSplit et le renommage pour justement introduire l'approche choisie (renommage) et les raisons (diminution de la taille des identifiants, aggrégation de l'ensemble des blocs existants)}

\section{Renaming in a centralized setting}
