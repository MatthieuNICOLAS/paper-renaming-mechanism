...
If the two epochs are equals, then nodes can apply the operation as it is.
Otherwise, it means that one or several \emph{rename} operations were applied locally since this operation has been issued.
Nodes have to transform the operation before applying it to preserve its semantic.
