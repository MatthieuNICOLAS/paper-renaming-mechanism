...
\begin{itemize}
    ...
    \item Generating and associating a position to each element of the sequence is expensive
    ...
    \item Define positions as aggregable if all but the $offsets$ of their last tuple are identical and their respective $offsets$ are consecutive
    ...
    \begin{itemize}
        ...
        \item It can be achieved by disabling flags allowing to preprend/append when the first/last element of a block is removed
    \end{itemize}
\end{itemize}
