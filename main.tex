...
Upon the delivery of \emph{rename} operations, nodes execute the following steps to apply them.
...
Some of these operations may even be concurrent to several \emph{rename} operations.
