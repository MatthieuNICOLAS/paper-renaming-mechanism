...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{img/integration-time-rename-0.pdf}
...
The time of integration of remote ones follows a supra-linear progression, since they rename each block of the current sequence using \verb|renameForwardPos()|, whose complexity is logarithmic.
